...
class CheckSavedState : View.BaseSavedState {
    ...
    companion object CREATOR : Parcelable.Creator<CheckSavedState> {
        ...
        override fun createFromParcel(parcel: Parcel): CheckSavedState = CheckSavedState(parcel)


        override fun newArray(size: Int): Array<CheckSavedState?> = arrayOfNulls(size)
